...
function getElementById1 () {
    ...
    depInput=document.getElementById("selectDep");
    lvlInput=document.getElementById("selectLvl");
    imgurlInput=document.getElementById("img")
    return [nameInput.value,depInput.value,lvlInput.value,imgurlInput.value]
}
...
function getDataFromLocal(){
    arr1=[]
    arr1.push(localStorage.getItem('localName'))
    arr1.push(localStorage.getItem('localDep'))
    arr1.push(localStorage.getItem('localLvl'))
    arr1.push(localStorage.getItem('localimg'))
    //arr.push(localStorage.getItem('localId'))
console.log(arr1);
localStorage.setItem('emplyee',arr1)
...
function createCard(fullNames,selectDeps,selectLvls,imgs){
